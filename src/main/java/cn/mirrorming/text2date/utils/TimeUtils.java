package cn.mirrorming.text2date.utils;
...
public final class TimeUtils {
     ...
     */
    private final static Map<Integer, String> lunarHolidayMap = new HashMap<>(11);

    /**
     * 键值：0-7位表示日期，8-11位表示月份，5-7位与12-15位恒为0
     */
    private final static Map<Integer, String> holidayMap = new HashMap<>(23);
